<template>
  <div class="wrapper cb-site-width">
    <cb-page-title text="Privacy Policy" />
    <section class="cb-content">
      ...
      <p>
        <strong>We use Google AdSense Advertising on our website.</strong><br>
        Google, as a third-party vendor, uses cookies to serve ads on our site. Google’s use of the DART cookie enables it to serve ads to our users based on previous visits to our site and other sites on the Internet. Users may opt-out of the use of the DART cookie by visiting the Google Ad and Content Network privacy policy.
      </p>
      We have implemented the following:
      We, along with third-party vendors such as Google use first-party cookies (such as the Google Analytics cookies) and third-party cookies (such as the DoubleClick cookie) or other third-party identifiers together to track statistics on site uses.
      ...
      <p>
        ...
        <br><strong>According to CalOPPA, we agree to the following:</strong><br>
      ...
      <p>
        ...
        support@inter-act.io and we will promptly remove you from ALL correspondence.
      </p>
      ...
      www.inter-act.io<br>
      100 Nahal Bsor St.<br>
      Kfar Yona, Hasharon 4030410<br>
      <br>
      Israel
      <br>
    </section>
